  ...
  return (
    <>
      <div
        ...
        className="p-4 max-w-4xl mx-auto mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800"
        role="alert"
      >
        ...
        <div className="mt-2 mb-4 text-sm">
          Thank you for creating an account with us. We have sent you a mail,
          please check your inbox and click to verify account to complete your
          onboarding process.
        </div>
        <div className="flex">
          <button
