...
import { passwordResetTemplate } from "@/components/mailers/templates/templates";
...
export async function PUT(request) {
  ...
  try {
    ...
    //const subject = "Password Reset - GemTunde Ecommerce";
    console.log(userId, name, redirectUrl);
    await sendEmail({
      to: existingUser.email,
      ...passwordResetTemplate(redirectUrl),
    });
