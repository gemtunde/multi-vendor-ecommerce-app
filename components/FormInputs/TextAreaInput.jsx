    ...
    <div className={className}>
      ...
      <div className="mt-2">
        <textarea
          ...
          // className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:bg-transparent dark:text-slate-50 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-slate-400 sm:text-sm sm:leading-6"
          defaultValue={""}
        />
        {errors[`${name}`] && (
